...
$(function () {
	...
	WebVideoCtrl.insertPluginObject("divPlugin","90%","70%");
	//初始化插件
...
function clickLogin()
{
	...
	var szIP = "192.168.1.108";
	szPort = 37777 - 0;
	szUsername = "admin";//$("#username").val();
	szPassword = "admin123";//$("#password").val();
	rtspPort = 80 - 0;
	protocol = 0;
...
function clickGetChannelTitle()
{
	var config = WebVideoCtrl.getConfig("ChannelTitle");
	alert(config)
	$('#config').html(config);
}